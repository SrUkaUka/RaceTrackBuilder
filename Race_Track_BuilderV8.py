bl_info = {
    "name": "CTR Track Builder",
    "blender": (4, 2, 1),
    "category": "Object",
    "author": "SirUka",
    "version": (1, 0, 0),
    "description": "An addon designed to quickly and easily create tracks for CTR (Crash Team Racing), helping you build roads and tiles for racing environments with ease.",
    "warning": "",
    "doc_url": "",
    "tracker_url": "",
    "support": "COMMUNITY",
...
class SimplePanel(bpy.types.Panel):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("mesh.create_1_tiles", text="Generate 1 Tile")
        layout.operator("mesh.create_2_tiles", text="Generate 2 Tiles")
        layout.operator("mesh.create_3_tiles", text="Generate 3 Tiles")
        layout.operator("mesh.create_4_tiles", text="Generate 4 Tiles")
        layout.operator("mesh.create_5_tiles", text="Generate 5 Tiles")
        layout.operator("mesh.create_6_tiles", text="Generate 6 Tiles")
        layout.operator("mesh.create_long_road", text="Long_Road")
        layout.operator("mesh.create_med_road", text="Med_Road")
        layout.operator("mesh.create_short_road", text="Short_Road")
